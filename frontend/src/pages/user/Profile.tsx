...
export default function Profile() {
  ...
  return (
    <div>
      ...
      {/* Danger Zone - Made more prominent */}
      <div className="mt-8 bg-red-50 border-2 border-red-300 rounded-xl p-6">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            <h3 className="text-lg font-bold text-red-900 mb-1">⚠️ Danger Zone</h3>
        ...
        <Link
          to="/delete-account"
          className="inline-flex items-center gap-2 px-5 py-3 bg-red-600 text-white rounded-lg text-sm font-bold hover:bg-red-700 transition-colors shadow-md hover:shadow-lg"
        >
